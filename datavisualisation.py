...
for rank in ranks:
    ...
    model_bias = pickle.load(open(os.path.join("trained_models", filename), "rb"))
...
plt.savefig(os.path.join("img","rank-rmse-validate.png"))
plt.figure()
plt.plot(rmses[:,0],rmses[:,1], color="blue", marker="o")
plt.plot(rmses[:,0],rmses[:,4], color="green", marker="o")
plt.title("RMSE on training set vs. matrix rank")
plt.ylabel("RMSE")
plt.xlabel("rank")
plt.savefig(os.path.join("img","rank-rmse-train.png"))
plt.figure()
...
plt.ylabel("RMSE")
plt.xlabel("lambda")
plt.savefig(os.path.join("img","lambda-rmse-validate.png"))
